...
proto1 = 'models/VGG16/coco/test_context.prototxt'
model1 = 'output/coco_baseline/coco_2014_train/context_batch_size_2_vgg16_%s_iter_240000.caffemodel' % ctx
proto2 = 'models/VGG16/coco/test_context.prototxt'
model2 = 'data/fast_rcnn_models/frcnn_coco_init.caffemodel'
save_model = 'output/coco_baseline/coco_2014_train/context_batch_size_2_vgg16_%s_combined.caffemodel' % ctx
